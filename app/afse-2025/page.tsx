    ...
    <>
      <section className="dark-section relative pt-32 pb-16 text-center" style={{ backgroundImage: "linear-gradient(180deg, rgba(0,0,0,0.6), rgba(0,0,0,0.85)), url(/img/afse2025-hero-bg.jpg)", backgroundSize: "cover", backgroundPosition: "center" }}>
        <div className="container">
          ...
          <h1 className="mt-2 text-[length:var(--text-h2)] text-white">UNITED BY FOOD.</h1>
      ...
      <section className="section">
        <div className="container grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            <h2 className="text-[length:var(--text-h2)]">The Future of African Food Starts Here.</h2>
        ...
        <div className="container mt-16 grid gap-5 md:grid-cols-3 lg:px-32">
          {[["50+", "Tickets claimed in the first week."], ["10+", "Industry leading speakers confirmed."], ["10,000+", "Participants joining from all over the world."]].map(([n, t]) => (
            <div key={n} className="card p-8"><p className="font-[family-name:var(--font-display)] text-[40px] font-semibold text-[color:var(--color-action)]">{n}</p><p className="mt-2 text-[13px]">{t}</p></div>
          ))}
        </div>
      </section>
      <section className="grid lg:grid-cols-2">
        ...
        <div className="dark-section p-10 lg:p-16">
          <h2 className="text-[length:var(--text-h2)] text-white">What Will You Take Away?</h2>
      ...
      <section className="section">
        <div className="container text-center">
          ...
          <h2 className="mt-4 text-[length:var(--text-h2)]">Who You Will Meet?</h2>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2">{AUDIENCE.map(([t, d]) => (
            <div key={t} className="rounded-xl border border-white/15 bg-white/[0.04] p-8 text-left text-white"><h3 className="text-[18px] text-white">{t}</h3><p className="mt-3 text-[13px] text-white/85"><strong className="text-white">Why Attend:</strong> {d}</p><div className="mt-6"><Btn href="#tickets" variant="outline-dark">Get A Ticket <Arrow /></Btn></div></div>
          ))}</div>
        </div>
      </section>
      <section className="dark-section py-20" style={{ backgroundImage: "linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url(/img/sponsorship.jpg)", backgroundSize: "cover", backgroundPosition: "center" }}>
        <div className="container flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
          <h2 className="text-[length:var(--text-h2)] text-white">Summit Schedule &<br />Information</h2>
      ...
      <section className="dark-section section">
        <div className="container text-center">
          <h2 className="text-[length:var(--text-h2)] text-white">Industry Leading Speakers</h2>
      ...
      <section id="tickets" className="section alt-section">
        <div className="container">
          <div className="text-center"><h2 className="mt-4 text-[length:var(--text-h2)]">Get Your Ticket</h2></div>
      ...
      <section className="dark-section section text-center">
        <div className="container max-w-3xl">
          <h2 className="text-[length:var(--text-h2)] text-white">African Food Influencers Awards (AFIA)</h2>
